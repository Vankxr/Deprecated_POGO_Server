...
--
-- Table structure for table `forts`
--
...
CREATE TABLE `forts` (
  ...
  `rendering_type` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `forts`
--

LOCK TABLES `forts` WRITE;
/*!40000 ALTER TABLE `forts` DISABLE KEYS */;
/*!40000 ALTER TABLE `forts` ENABLE KEYS */;
UNLOCK TABLES;
